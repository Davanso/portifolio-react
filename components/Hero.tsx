...
const Hero = () => {
  return (
    <div className='pb-20 pt-36 min-h-screen'>
       ...
       dark:bg-black-100 bg-white dark:bg-grid-white/[0.03] bg-grid-black/[0.2] 
       absolute top-0 left-0 flex items-center justify-center">
        ...
        items-center justify-center'>
            ...
            <TextGenerateEffect
                ...
                words='Transforming Concepts into Experiences'
            />

            <p className='text-center
            md:tracking-wider md:text-lg lg:text-2xl 
            mb-4 text-sm'>
                Hi, I&apos;m Guilherme, a Frontend Developer
            </p>
