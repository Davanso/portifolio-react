...
export const gridItems = [
  {
    id: 1,
    title: "I'm studying very hard to improve my skils more and more",
    description: "",
...
export const workExperience = [
  ...
  {
    id: 4,
    title: "Starting to do my own projects...",
    desc: "Always learning more and more, trying to challenge myself everyday",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
